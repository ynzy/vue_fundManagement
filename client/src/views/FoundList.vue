...
<template>
	<div class="fillcontain">
		...
		<div class="table_container">
			<el-table v-if="tableData.length > 0" :data="tableData" max-height="800" border :default-sort="{ prop: 'date', order: 'descending' }" style="width: 100%">
				...
				<el-table-column prop="operation" align="center" label="操作" fixed="right" width="240" v-if="user.identity == 'manager'">
					<template slot-scope="scope">
						...
						<el-button type="primary" icon="search" size="small" @click="onShow(scope.row._id)">
							查看
